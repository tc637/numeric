...
ax5.set_title(r"Advection of M with the Bulk Scheme, t = {} s".format(n_time*dt))
ax6.set_title(r"Advection of N with the Bulk Scheme, t = {} s".format(n_time*dt))
ax5.set(xlabel=r"$M\ (g\ kg^{-1})$", ylabel=r"$z\ (m)$")
ax6.set(xlabel=r"$N\ (kg^{-1})$", ylabel=r"$z\ (m)$")
