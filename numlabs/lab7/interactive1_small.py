#!/usr/bin/env python
"""Interactive One.  Initialize a Gaussian bump in surface height and allow it evolve.  Although
the Coriolis force is included, the scale is so small, its effect is negligible"""
...
# recommended values ngrid=11, dt=4, T=90
